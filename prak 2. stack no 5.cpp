// Ahmad Daniyal Fayyadh_20051397037_2020A
// (5) STACK - program notasi infix dan postfix
...
void inputElemen(type_stack &namastack){
 ...
 cout<<"tekan enter setelah selesai menginputkan 1 element,  \n"<<
  "jika dirasa cukup, maka inputkan '=' untuk proses selanjutnya \n";

 string dataElemen;					//setiap kali memilih menu 1, maka string dataelemen diberinilai kosong("")
 dataElemen="";
...
//fungsi convert string to double
...
//fungsi convert double to string
...
int main(){ 
 ...
 Menu :
  ...
  cout<< "==============================================" << endl;
  cout<< endl;
  cout<< " 1) Input Expresi Aritmathik (Infix) : "<<endl;
  cout<< " 2) Konvert Expresi Infix ke Postfix : "<<endl;
  cout<< " 3) Hasil perhitungan Expresi : "<<endl;
  cout<< " 4) Keluar "<<endl;
  cout<< endl;
  cout<< "==============================================" << endl;
  cout<< endl;
